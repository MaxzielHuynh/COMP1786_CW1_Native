...
public class MExpenseDAO {
    ...
    public ArrayList<Trip> getTripList(Trip trip, String[] orderByColumns, boolean isDesc) {
        ...
        if (null != trip) {
            ...
            if (trip.getStartDate() != null && !trip.getStartDate().trim().isEmpty()) {
                selection += " AND " + TripEntry.COL_INITIATION_DATE + " = ?";
    ...
    protected ContentValues getTripValues(Trip trip) {
        ...
        values.put(TripEntry.COL_INITIATION_DATE, trip.getStartDate());
        values.put(TripEntry.COL_FINALE_DATE, trip.getEndDate());
    ...
    protected ArrayList<Trip> getTripFromDB(String[] columns, String selection, String[] selectionArgs, String groupBy, String having, String orderBy) {
        ...
        while (cursor.moveToNext()) {
            ...
            tripItem.setStartDate(cursor.getString(cursor.getColumnIndexOrThrow(TripEntry.COL_INITIATION_DATE)));
            tripItem.setEndDate(cursor.getString(cursor.getColumnIndexOrThrow(TripEntry.COL_FINALE_DATE)));
